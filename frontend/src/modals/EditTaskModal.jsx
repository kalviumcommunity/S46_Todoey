...
function EditTaskModal({ onPress, oldTask, updateTask }) {
  const [text, setText] = useState("");
  const [isEmpty, setIsEmpty] = useState(false);

  useEffect(() => {
    setText(oldTask.task);
  }, [oldTask]);
      ...
      <div className="w-full shadow-md sm:w-1/4">
        ...
        <div className="p-4 flex flex-col justify-center content-center flex-wrap bg-white">
          <div className=" my-4">
            <input
              type="text"
              className="border-b-2 hover:border-blue-500 text-center focus:outline-none focus:border-blue-500 w-fit"
              placeholder="Task"
